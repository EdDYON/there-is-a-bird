...
public class BirdDroppingSplatModel extends GeoModel<BirdDroppingSplatEntity> {
    private static final ResourceLocation MODEL = ResourceLocation.fromNamespaceAndPath("guaniao", "geo/bird_dropping_splat.geo.json");
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath("guaniao", "textures/entity/bird_dropping_splat.png");
