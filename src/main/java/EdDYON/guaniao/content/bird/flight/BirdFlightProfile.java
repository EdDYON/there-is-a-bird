...
public final class BirdFlightProfile {
    ...
    public static final BirdFlightProfile COCKATIEL = new BirdFlightProfile(4.0D, 11.0D, 0.27D, 0.35D, 0.20D, 100, 280, 5.0D, 15.0D, 4.8D, 40.0F);
    public static final BirdFlightProfile MACAW = new BirdFlightProfile(6.0D, 16.0D, 0.28D, 0.37D, 0.22D, 120, 320, 7.0D, 20.0D, 6.5D, 36.0F);
    // Large parrot flight, but heavier on the wings: a lower cruise speed and a
    // shorter air-target distance mean more flapping and fewer long glides, and
    // it prefers short hops between perches rather than crossing open ground.
    public static final BirdFlightProfile UMBRELLA_COCKATOO = new BirdFlightProfile(6.0D, 16.0D, 0.26D, 0.35D, 0.22D, 130, 340, 7.0D, 18.0D, 6.0D, 38.0F);
    ...
    public static final BirdFlightProfile WOODCOCK = new BirdFlightProfile(1.5D, 6.0D, 0.36D, 0.50D, 0.22D, 40, 105, 12.0D, 30.0D, 3.5D, 34.0F);
    public static final BirdFlightProfile KESTREL = new BirdFlightProfile(13.0D, 28.0D, 0.62D, 0.84D, 0.28D, 140, 380, 24.0D, 48.0D, 8.0D, 48.0F);
